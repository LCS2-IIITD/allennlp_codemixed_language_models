"""
Implements the DatasetReader for our language model.
Code taken from: https://github.com/allenai/allennlp/blob/2850579831f392467276f1ab6d5cda3fdb45c3ba/allennlp/data/dataset_readers/simple_language_modeling.py
"""
import logging
import math
...
@DatasetReader.register("elmo_multi2cross_lm_reader")
class SimpleLMDatasetReader(DatasetReader):
    """
    ...
    def __init__(
        ...
        logger.info("Creating SimpleLMDatasetReader")
