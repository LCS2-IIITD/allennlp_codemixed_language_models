...
@Model.register("elmo_multi2cross_lm")
class ElmoMulti2CrossLM(Model):
    """
    ...
    def forward(  # type: ignore
        ...
        for lang in self.langs:
            all_embeddings.append(self._text_field_embedder(source, lang=lang))
        ...
        if token_ids is not None:
            ...
            forward_loss, backward_loss = self._compute_loss(
                contextual_embeddings_with_dropout, all_embeddings, forward_targets, backward_targets
            )
        ...
        return_dict.update(
            {
                ...
                "noncontextual_token_embeddings": all_embeddings,
                "mask": mask,
            }
        )
